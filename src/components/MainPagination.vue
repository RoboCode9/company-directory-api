...
<div class="flex justify-center gap-4 p-8">
    ...
    <button @click="prevPage" :disabled="activePage === 1" class="rounded-md bg-slate-500 p-2 font-medium text-slate-700 shadow-md">PREV</button>
    ...
    <button @click="nextPage" :disabled="activePage === pages" class="rounded-md bg-slate-500 p-2 font-medium text-slate-700 shadow-md">NEXT</button>
